...
"WEATHER","HOWAREYOU","JOKE","DATE","$accept","chatbot","greeting","farewell",
"query","illegal-symbol",
};
...
case 7:
#line 29 "chatbot.y"
	{ printf("Chatbot: My name is ChatGPT.\n"); }
#line 1004 "y.tab.c"
break;
case 8:
#line 30 "chatbot.y"
	{ printf("Chatbot: I can't check the weather right now, but you can check a weather website or app.\n"); }
#line 1009 "y.tab.c"
break;
case 9:
#line 31 "chatbot.y"
	{ printf("Chatbot: I'm just a bunch of code, but thanks for asking! How are you?\n"); }
#line 1014 "y.tab.c"
break;
case 10:
#line 32 "chatbot.y"
